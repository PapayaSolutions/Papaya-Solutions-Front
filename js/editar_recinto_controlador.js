...
input_estado.disabled = false;
let _idEvento = sessionStorage.getItem('_idEvento');

let llenarformulario = async() => {
    let recinto = await obtenerun_recinto_id(_idEvento);
    ...
    input_direccion.value = recinto['direccion'];
    input_asientos_tradicionales.value = recinto['asientos_tradicionales'];
    input_asientos_accesibilidad.value = recinto['asientos_accesibilidad'];
    input_latitud.value = recinto['latitud'];
    input_longitud.value = recinto['longitud'];
}
...
let obtener_datos = () => {
    ...
    editar_recinto = async(direccion, provincia, capacidad, asientos_tradicionales, asientos_accesibilidad, latitud, longitud, estado)
